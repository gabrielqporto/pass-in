...
public class ExceptionEntityHandler {
    ...
    public ResponseEntity handleAttendeeAlreadyExist(AttendeeAlreadyExistException attendeeAlreadyExistException) {
        return ResponseEntity.status(HttpStatus.CONFLICT).build();
    }

    @ExceptionHandler(CheckInAlreadyExistsException.class)
    public ResponseEntity handleCheckInAlreadyExist(CheckInAlreadyExistsException checkInAlreadyExistException) {
        return ResponseEntity.status(HttpStatus.CONFLICT).build();
    }
